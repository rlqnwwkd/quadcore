...
public class GeofenceSettingsActivity_Rectangle_6_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geofence_settings__rectangle_6_6);
    ...
    public void onConfirmBtnClicked(View view)
    {
        ...
        {
            beaconPositionTransferThread = new GeofenceSettingsActivity_Rectangle_6_6.BeaconPositionTransferThread();
        ...
        {
            // 가짜 데이터 삽입
            Point3D bc1 = com.quadcore.Room.Room_Rectangle_6_6.bc1Position;
            Point3D bc2 = com.quadcore.Room.Room_Rectangle_6_6.bc2Position;
            Point3D bc3 = Room_Rectangle_6_6.bc3Position;
            Point3D bc4 = com.quadcore.Room.Room_Rectangle_6_6.bc4Position;
            Point3D zoneLeftTop = com.quadcore.Room.Room_Rectangle_6_6.leftUp;
            Point3D zoneRightDown = com.quadcore.Room.Room_Rectangle_6_6.rightDown;
            MockServer.insertGeofence_type(bc1,bc2,bc3,bc4,zoneLeftTop,zoneRightDown,Constants._ROOM_TYPE_RECTANGLE_6_6);
        ...
        GeofenceView_main.screenRatio = com.quadcore.Room.Room_Rectangle_6_6.screenRatio;
        ((GeofenceView_main) MainActivity.view).locatedBeaconCnt=3;
        MainActivity.roomType = Constants._ROOM_TYPE_RECTANGLE_6_6;
    }
    ...
    private void popupToast(final String msg) {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                // 내용
                Toast.makeText(GeofenceSettingsActivity_Rectangle_6_6.this, msg,Toast.LENGTH_SHORT).show();
            }
        }, 0);
    }
}
