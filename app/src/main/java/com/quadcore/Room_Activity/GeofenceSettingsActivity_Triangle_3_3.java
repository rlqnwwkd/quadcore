...
public class GeofenceSettingsActivity_Triangle_3_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geofence_settings__triangle_3_3);
    ...
    public void onConfirmBtnClicked(View view)
    {
        ...
        {
            // 가짜 데이터 삽입
            Point3D bc1 = Room_Triangle_3_3.bc1Position;
            Point3D bc2 = Room_Triangle_3_3.bc2Position;
            Point3D bc3 = Room_Triangle_3_3.bc3Position;
            Point3D bc4 = Room_Triangle_3_3.bc4Position;
            Point3D zoneLeftTop = Room_Triangle_3_3.leftUp;
            Point3D zoneRightDown = Room_Triangle_3_3.rightDown;
            MockServer.insertGeofence_type(bc1,bc2,bc3,bc4,zoneLeftTop,zoneRightDown, Constants._ROOM_TYPE_TRIANGLE_3_3);
    ...
    class BeaconPositionTransferThread extends Thread
    {
        ...
        public void run()
        {
            ...
            String param_bc = "bcPositions="+Room_Triangle_3_3.bc1Position.getX()+","+Room_Triangle_3_3.bc1Position.getY()
                    +","+Room_Triangle_3_3.bc2Position.getX()+","+Room_Triangle_3_3.bc2Position.getY()
                    +","+Room_Triangle_3_3.bc3Position.getX()+","+Room_Triangle_3_3.bc3Position.getY()
                    +","+Room_Triangle_3_3.bc4Position.getX()+","+Room_Triangle_3_3.bc4Position.getY();
            String param_id = "id="+ Constants.MAJOR_BEACON_1;
            String param_name = "name=counter";
            String param_type = "type="+ Constants._ROOM_TYPE_TRIANGLE_3_3;
            String param_zone = "zonePosition="+String.format("%.2f", Room_Triangle_3_3.leftUp.getX())+","+String.format("%.2f",Room_Triangle_3_3.leftUp.getY())
                    +","+String.format("%.2f",Room_Triangle_3_3.rightDown.getX())+","+String.format("%.2f",Room_Triangle_3_3.rightDown.getY());
            ...
            catch(SocketTimeoutException ste)
            {
                ...
                // Log & Toast
                //////////////////////////
                Log.d(Constants.QUADCORE_LOG, "SERVER CONNECTION FAILED : SocketTimeoutExcpetion");
                popupToast("SERVER CONNECTION FAILED");
                isConnected = false;
            }
            catch(ConnectException e)
            {
                Log.d(Constants.QUADCORE_LOG,"SERVER CONNECTION FAILED : ConnectionException");
                popupToast("SERVER CONNECTION FAILED");
                isConnected = false;
            }
            catch(Exception e)
    ...
    private void popupToast(final String  msg) {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                // 내용
                Toast.makeText(GeofenceSettingsActivity_Triangle_3_3.this, msg,Toast.LENGTH_SHORT).show();
            }
        }, 0);
    }
}
