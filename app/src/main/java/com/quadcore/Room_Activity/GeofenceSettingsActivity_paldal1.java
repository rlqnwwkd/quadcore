...
public class GeofenceSettingsActivity_paldal1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geofence_settings_paldal1);
    ...
    public void onConfirmBtnClicked(View view)
    {
        ...
        {
            beaconPositionTransferThread = new GeofenceSettingsActivity_paldal1.BeaconPositionTransferThread();
        ...
        {
            // 가짜 데이터 삽입
            Point3D bc1 = Room_Paldal1.bc1Position;
            Point3D bc2 = Room_Paldal1.bc2Position;
            Point3D bc3 = Room_Paldal1.bc3Position;
            Point3D bc4 = Room_Paldal1.bc4Position;
            Point3D zoneLeftTop = Room_Paldal1.leftUp;
            Point3D zoneRightDown = Room_Paldal1.rightDown;
            MockServer.insertGeofence_type(bc1,bc2,bc3,bc4,zoneLeftTop,zoneRightDown, Constants._ROOM_TYPE_Paldal1);
        ...
        MainActivity.roomType = Constants._ROOM_TYPE_Paldal1;
    }
    ...
    class BeaconPositionTransferThread extends Thread
    {
        ...
        public void run()
        {
            ...
            String param_bc = "bcPositions="+Room_Paldal1.bc1Position.getX()+","+Room_Paldal1.bc1Position.getY()
                    +","+Room_Paldal1.bc2Position.getX()+","+Room_Paldal1.bc2Position.getY()
                    +","+Room_Paldal1.bc3Position.getX()+","+Room_Paldal1.bc3Position.getY()
                    +","+Room_Paldal1.bc4Position.getX()+","+Room_Paldal1.bc4Position.getY();
            String param_id = "id="+ Constants.MAJOR_BEACON_1;
            String param_name = "name=counter";
            String param_type = "type="+ Constants._ROOM_TYPE_Paldal1;
            String param_zone = "zonePosition="+String.format("%.2f", Room_Paldal1.leftUp.getX())+","+String.format("%.2f",Room_Paldal1.leftUp.getY())
                    +","+String.format("%.2f",Room_Paldal1.rightDown.getX())+","+String.format("%.2f",Room_Paldal1.rightDown.getY());
    ...
    private void popupToast(final String msg) {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                // 내용
                Toast.makeText(GeofenceSettingsActivity_paldal1.this, msg,Toast.LENGTH_SHORT).show();
            }
        }, 0);
    }
}
